...
path = "training_2"
s=os.path.dirname(os.path.abspath('TrainingModel2_saved'))+"\TrainingModel2_saved"
...
def predict(img):
    ...
    return "The piece of clothing is a " + str(class_names[np.argmax(results)])
